    ...
    for (int s = 0; s < 3; s++) {
        ...
        for (int alg = 0; alg < 4; alg++) {
            ...
            for (int t = 0; t < trials; t++) {
                ...
                clock_t start = clock();
                if (alg == 0) sort_select_int(arr, n);
                if (alg == 1) sort_bubble_int(arr, n);
                if (alg == 2) sort_cocktail_int(arr, n);
                if (alg == 3) sort_insert_int(arr, n);
